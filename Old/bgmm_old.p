...
DEF VAR blankSlate AS LOG  NO-UNDO.
...
/* IF TIME >= 61200 THEN ASSIGN Purge = yes. /*Purge*/ */
/* ELSE ASSIGN Purge = no.                             */
    ...
    IF CAN-FIND(FIRST bgdet WHERE bgdet.RUN_time < TIME) THEN DO:
        ...
        DO FOR buf_bgdet TRANSACTION:
            FOR EACH bgdet WHERE run_time < TIME:
                ASSIGN blankslate = bgdet.blankslate.
                DELETE bgdet.
            END.
        END.
