...
DEFINE {1} SHARED VARIABLE ranFolder             AS CHARACTER  NO-UNDO.
    ranFolder = imageShare + "AgentPhotos\Temporary\mtl\CompletedBatches".   
    
DEFINE {1} SHARED VARIABLE jmLogs                AS CHARACTER  NO-UNDO.       
    jmLogs = imageShare + "AgentPhotos\Temporary\MM Logs".
